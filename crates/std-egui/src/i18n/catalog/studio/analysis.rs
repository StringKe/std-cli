...
pub(super) fn translate(locale: Locale, key: &str) -> Option<&'static str> {
    match (locale, key) {
        ...
        (Locale::ZhCn, "studio.analysis.search_hits") => Some("搜索命中"),
        (Locale::EnUs, "studio.analysis.search_hits") => Some("Search hits"),
        ...
        (Locale::ZhCn, "studio.analysis.sources") => Some("来源"),
        (Locale::EnUs, "studio.analysis.sources") => Some("Sources"),
...
pub(super) fn fallback(key: &str) -> Option<&'static str> {
    match key {
        ...
        "studio.analysis.search_hits" => Some("Search hits"),
        "studio.analysis.inspect" => Some("Inspect"),
        "studio.analysis.answer" => Some("Answer"),
        "studio.analysis.sources" => Some("Sources"),
