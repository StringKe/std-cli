...
pub(crate) struct StudioSmokeReport {
    ...
    pane_lifecycle_contract: String,
    ...
    host_chrome_input_contract: &'static str,
...
pub(crate) fn smoke_from_args(args: Vec<String>) -> Option<StudioSmokeReport> {
    ...
    match run_studio_smoke() {
        ...
        Err(error) => Some(failed_studio_smoke_report(&error.to_string())),
    }
}

pub(crate) fn failed_studio_smoke_report(error: &str) -> StudioSmokeReport {
    StudioSmokeReport {
        workspace_panes: 0,
        focused_pane: 0,
        pane_opened: false,
        ...
        pane_lifecycle_contract: "FAIL".to_string(),
        ...
        host_viewport_contract: "FAIL".to_string(),
        host_chrome_contract: "FAIL",
        host_chrome_input_contract: "FAIL",
...
fn report_from_inputs(
    ...
    StudioSmokeReport {
        ...
        pane_lifecycle_contract: pane_smoke.lifecycle_contract,
        ...
        host_viewport_contract: inputs.layout.host_viewport_contract,
        host_chrome_contract: inputs.layout.host_chrome_contract,
        host_chrome_input_contract: inputs.layout.host_chrome_input_contract,
