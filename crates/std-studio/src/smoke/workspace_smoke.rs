...
pub(crate) fn run_workspace_pane_smoke(
    ...
    let settings_contract = format!(
        "surface={},navigation={},categories={},hotkey_source={},hotkey_reset={},hotkey_control={},theme_modes={},theme_control={},motion_control={},contrast_control={},transparency_control={},ai_control={},storage_control={}",
