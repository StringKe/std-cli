...
pub struct LauncherKeyboardReport {
    ...
    pub user_enter_window_commands: String,
    pub pinned_enter_status: Option<ActionExecutionStatus>,
    pub pinned_enter_keeps_launcher_open: bool,
    pub pinned_enter_window_commands: String,
    pub executing_enter_path: String,
    pub executing_enter_hidden: bool,
    pub executing_cancel_phase: LauncherPhase,
    pub executing_cancel_focus: LauncherFocusSection,
    ...
    pub shortcut_help_contract: String,
