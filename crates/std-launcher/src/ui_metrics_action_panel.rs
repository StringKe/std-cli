...
const ACTION_PANEL_FOCUS_EXPAND: f32 = 2.0;
...
pub(crate) fn focus_expand(scale: UiScale) -> f32 {
    scale.f32(ACTION_PANEL_FOCUS_EXPAND)
}
...
#[cfg(test)]
pub(crate) fn metrics_for_scale(scale: UiScale, anchor_width: f32) -> (f32, f32, f32, f32, f32) {
    (
